...
def parse_args():
	...
	parser.add_argument('--time_slot', default=60*60*24*5, type=float, help='length of time slots')  #
	...
	parser.add_argument('--cl_short_rate', default=0.013, type=float, help='cl_rate')
