...
import myModel_ori
import myModel_ori_ssl_dynamic_train_position
...
class Model():
    def __init__(self):
        ...
        self.position_file = args.path + args.dataset + '/position_trn_'     #6, 8, 11, 15, 58
        ...
        # self.subgraphs = hypergraph_utils.sparse_matrix_to_torch_sparse_tensor(self.subgraphs, self.time_number, self.behaviors)  
    ...
    def prepareModel(self):
        ...
        if args.isload == True:
            ...
            self.model = myModel_ori_ssl_dynamic_train_position.myModel(self.user_num, self.item_num, self.time_number, self.behaviors, self.subgraphs)
    ...
    def batched_contrastive_loss(self, z1, z2, batch_size=1024):
        ...
        for i in range(num_batches):
            ...
            for j in range(num_batches):
                ...
                tmp_refl_sim = f(self.sim(z1[tmp_i], z1[tmp_j]))  # [B, N]
                tmp_between_sim = f(self.sim(z1[tmp_i], z2[tmp_j]))  # [B, N]
